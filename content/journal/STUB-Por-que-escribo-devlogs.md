...
- La tensión entre escribir para uno mismo y escribir para una audiencia
- Qué hace que un devlog sea útil retrospectivamente (no solo un diario)
- La fantasía de la edición física: qué referentes tiene, qué costaría, si es viable hoy
- Relación entre escribir sobre el proyecto y entenderlo mejor
