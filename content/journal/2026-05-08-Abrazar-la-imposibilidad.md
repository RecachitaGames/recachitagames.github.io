...
Esas restricciones, sin embargo, tienen un efecto que no anticipé del todo: cuando no puedes resolver algo con atajos, tienes que entenderlo de verdad. La limitación obliga a la comprensión. A veces, eso es suficiente para que algo florezca.
